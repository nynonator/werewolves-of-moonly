<div>
    <div class="shadow[color: #fffff)] ">
        ...
        <button
            class="focus:pointer-events-auto bg-white/10 rounded-full p-5 w-full @if ($selection == 'verteller') border border-white @endif"
            wire:click="save('verteller')">
    ...
    <div class="mt-4">
        <button class="bg-white/10 rounded-full p-5 w-full @if ($selection == 'speler') border border-white @endif"
            wire:click="save('speler')">
            <div class="flex justify-center flex-col">
